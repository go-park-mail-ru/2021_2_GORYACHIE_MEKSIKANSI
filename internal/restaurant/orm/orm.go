//go:generate mockgen -destination=mocks/orm.go -package=mocks 2021_2_GORYACHIE_MEKSIKANSI/internal/restaurant/orm WrapperRestaurantServerInterface,ConnectRestaurantServiceInterface
package orm
