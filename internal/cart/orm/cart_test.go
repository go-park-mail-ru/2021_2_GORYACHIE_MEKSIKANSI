...
import (
	...
	"2021_2_GORYACHIE_MEKSIKANSI/internal/cart/application"
...
var OrmGetCart = []struct {
...
}{
	{
		testName: "One",
		input:    1,
		outOne: &cart.ResponseCartErrors{Restaurant: cart.RestaurantIdCastResponse{
			Id: 0, Img: "", Name: "", CostForFreeDelivery: 0, MinDelivery: 0, MaxDelivery: 0, Rating: 0},
			Dishes: []cart.DishesCartResponse(nil), Cost: cart.CostCartResponse{DCost: 0, SumCost: 0},
			DishErr: []cart.CastDishesErrs(nil)},
		outTwo:      nil,
		outErr:      "",
		inputQuery:  1,
		resultQuery: Rows{},
...
var OrmUpdateCartStructFood = []struct {
	...
	{
		testName:              "One",
		inputIngredient:       []cart.IngredientsCartRequest{{Id: 1}},
		inputClientId:         1,
		out:                   []cart.IngredientCartResponse{{Name: "1", Id: 1, Cost: 1}},
		outErr:                "",
		inputQuery:            1,
...
var OrmUpdateCartRadios = []struct {
	...
	{
		testName:            "One",
		inputRadios:         []cart.RadiosCartRequest{{Id: 1, RadiosId: 1}},
		inputClientId:       1,
		out:                 []cart.RadiosCartResponse{{Name: "1", RadiosId: 0, Id: 1}},
		outErr:              "",
		inputQuery:          1,
...
var OrmUpdateCart = []struct {
...
}{
	{
		testName:      "One",
		inputClientId: 1,
		inputCart: cart.RequestCartDefault{Restaurant: cart.RestaurantRequest{Id: 1},
			Dishes: []cart.DishesRequest{{Id: 1, ItemNumber: 1, Count: 1,
				Radios:      []cart.RadiosCartRequest{{RadiosId: 1, Id: 1}},
				Ingredients: []cart.IngredientsCartRequest{{Id: 1}}}}},
		outOne: &cart.ResponseCartErrors{
			...
			Dishes: []cart.DishesCartResponse{
				{Id: 1, ItemNumber: 0, Img: "1", Name: "1", Count: 1, Cost: 1, Kilocalorie: 1,
					...
					RadiosCart:     []cart.RadiosCartResponse{{Name: "1", RadiosId: 0, Id: 1}},
					IngredientCart: []cart.IngredientCartResponse{{Name: "1", Id: 1, Cost: 1}}}},
			Cost: cart.CostCartResponse{DCost: 0, SumCost: 0}, DishErr: []cart.CastDishesErrs(nil)},
		outTwo:                      []cart.CastDishesErrs(nil),
		outErr:                      "",
...
var ApplicationCalculateCost = []struct {
	testName       string
	out            *cart.CostCartResponse
	outErr         string
	inputResult    *cart.ResponseCartErrors
	inputRest      *Utils2.RestaurantId
	inputGetPrice  int
	resultGetPrice int
	errGetPrice    error
	countGetPrice  int
	...
	{
		inputResult: &cart.ResponseCartErrors{
			Dishes:     []cart.DishesCartResponse{{Cost: 1, Count: 1}},
			Cost:       cart.CostCartResponse{SumCost: 1},
			Restaurant: cart.RestaurantIdCastResponse{CostForFreeDelivery: 5}},
		inputRest:      &Utils2.RestaurantId{Id: 1, CostForFreeDelivery: 5},
		inputGetPrice:  1,
		resultGetPrice: 1,
		testName:       "One",
		outErr:         "",
		out:            &cart.CostCartResponse{DCost: 1, SumCost: 2},
		errGetPrice:    nil,
		countGetPrice:  1,
	},
}
...
var ApplicationGetCart = []struct {
	...
	countGetPrice            int
	inputGetCart             int
	resultGetCartResult      *cart.ResponseCartErrors
	resultGetCartErrorDishes []cart.CastDishesErrs
	errGetCart               error
	inputGeneralInfo         int
	resultGeneralInfo        *Utils2.RestaurantId
...
}{
	{
		...
		countGetPrice:            0,
		inputGetCart:             1,
		resultGetCartResult:      &cart.ResponseCartErrors{Restaurant: cart.RestaurantIdCastResponse{Id: 1}},
		resultGetCartErrorDishes: []cart.CastDishesErrs{},
		errGetCart:               nil,
		inputGeneralInfo:         1,
		resultGeneralInfo:        &Utils2.RestaurantId{Id: 1},
		errGeneralInfo:           nil,
		countGeneralInfo:         1,
	},
}
...
func TestApplicationGetCart(t *testing.T) {
	...
	for _, tt := range ApplicationGetCart {
		...
		test := application.Cart{DB: m, DBRestaurant: mRest}
		t.Run(tt.testName, func(t *testing.T) {
...
var ApplicationUpdateCart = []struct {
	...
	errGetPrice             error
	countGetPrice           int
	inputUpdateDishes       cart.RequestCartDefault
	inputUpdateId           int
	resultUpdateResult      *cart.ResponseCartErrors
	resultUpdateErrorDishes []cart.CastDishesErrs
	errUpdate               error
	countUpdate             int
	inputGeneralInfo        int
	resultGeneralInfo       *Utils2.RestaurantId
	...
	{
		testName:    "One",
		inputDishes: cart.RequestCartDefault{Restaurant: cart.RestaurantRequest{Id: 1}},
		inputId:     1,
		out: &cart.ResponseCartErrors{
			Restaurant: cart.RestaurantIdCastResponse{
				Id: 1, Img: "", Name: "", CostForFreeDelivery: 0, MinDelivery: 0, MaxDelivery: 0, Rating: 0},
		...
		errGetPrice:             nil,
		countGetPrice:           0,
		inputUpdateDishes:       cart.RequestCartDefault{Restaurant: cart.RestaurantRequest{Id: 1}},
		inputUpdateId:           1,
		resultUpdateResult:      &cart.ResponseCartErrors{Restaurant: cart.RestaurantIdCastResponse{Id: 1}},
		resultUpdateErrorDishes: []cart.CastDishesErrs{},
		errUpdate:               nil,
		countUpdate:             1,
		inputGeneralInfo:        1,
