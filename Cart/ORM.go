...
func (db *Wrapper) updateCartStructFood(ingredients []Utils.IngredientsCartRequest, clientId int, tx pgx.Tx, cartId int) ([]Utils.IngredientCartResponse, error) {
...
func (db *Wrapper) updateCartRadios(radios []Utils.RadiosCartRequest, clientId int, tx pgx.Tx, cartId int) ([]Utils.RadiosCartResponse, error) {
