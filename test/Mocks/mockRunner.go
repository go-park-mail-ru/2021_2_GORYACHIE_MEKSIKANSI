...
// Source: 2021_2_GORYACHIE_MEKSIKANSI/Interface (interfaces: ConnectionInterface,WrapperRestaurant,WrapperProfile,WrapperAuthorization,WrapperCart,WrapperMiddleware,TransactionInterface,Uploader)
...
func (m *MockWrapperRestaurant) GetDishes(arg0, arg1 int) (*Restaurant.Dishes, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperRestaurant) GetMenu(arg0 int) ([]Restaurant.Menu, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMenu", arg0)
	ret0, _ := ret[0].([]Restaurant.Menu)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockWrapperRestaurant) GetRadios(arg0 int) ([]Restaurant.Radios, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRadios", arg0)
	ret0, _ := ret[0].([]Restaurant.Radios)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockWrapperRestaurant) GetRestaurants() ([]Restaurant.Restaurants, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperRestaurant) GetStructDishes(arg0 int) ([]Restaurant.Ingredients, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStructDishes", arg0)
	ret0, _ := ret[0].([]Restaurant.Ingredients)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockWrapperRestaurant) GetTagsRestaurant(arg0 int) ([]Restaurant.Tag, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTagsRestaurant", arg0)
	ret0, _ := ret[0].([]Restaurant.Tag)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockWrapperProfile) GetProfileClient(arg0 int) (*Profile.Profile, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperProfile) GetProfileCourier(arg0 int) (*Profile.Profile, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperProfile) GetProfileHost(arg0 int) (*Profile.Profile, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperProfile) UpdateAddress(arg0 int, arg1 Profile.AddressCoordinates) error {
	m.ctrl.T.Helper()
...
func (m *MockWrapperProfile) UpdateAvatar(arg0 int, arg1 *Profile.UpdateAvatar) error {
	m.ctrl.T.Helper()
...
func (m *MockWrapperAuthorization) AddCookie(arg0 *Utils2.Defense, arg1 int) error {
	m.ctrl.T.Helper()
...
func (m *MockWrapperAuthorization) addTransactionCookie(arg0 *Utils2.Defense, arg1 pgx.Tx, arg2 int) error {
	m.ctrl.T.Helper()
...
func (m *MockWrapperAuthorization) generalSignUp(arg0 *Authorization.RegistrationRequest, arg1 pgx.Tx) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperAuthorization) NewDefense() *Utils2.Defense {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewDefense")
	ret0, _ := ret[0].(*Utils2.Defense)
	return ret0
}
...
func (m *MockWrapperAuthorization) SignupClient(arg0 *Authorization.RegistrationRequest, arg1 *Utils2.Defense) (*Utils2.Defense, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperAuthorization) SignupCourier(arg0 *Authorization.RegistrationRequest, arg1 *Utils2.Defense) (*Utils2.Defense, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperAuthorization) SignupHost(arg0 *Authorization.RegistrationRequest, arg1 *Utils2.Defense) (*Utils2.Defense, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperCart) GetCart(arg0 int) (*Cart.ResponseCartErrors, []Cart.CastDishesErrs, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperCart) getStructFood(arg0 int) ([]Cart.IngredientCartResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "getStructFood", arg0)
	ret0, _ := ret[0].([]Cart.IngredientCartResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockWrapperCart) getStructRadios(arg0 int) ([]Cart.RadiosCartResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "getStructRadios", arg0)
	ret0, _ := ret[0].([]Cart.RadiosCartResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockWrapperCart) UpdateCart(arg0 Cart.RequestCartDefault, arg1 int) (*Cart.ResponseCartErrors, []Cart.CastDishesErrs, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperCart) updateCartRadios(arg0 []Cart.RadiosCartRequest, arg1 int, arg2 pgx.Tx) ([]Cart.RadiosCartResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperCart) updateCartStructFood(arg0 []Cart.IngredientsCartRequest, arg1 int, arg2 pgx.Tx) ([]Cart.IngredientCartResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperMiddleware) CheckAccess(arg0 *Utils2.Defense) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperMiddleware) GetIdByCookie(arg0 *Utils2.Defense) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockWrapperMiddleware) NewCSRF(arg0 *Utils2.Defense) (string, error) {
	m.ctrl.T.Helper()
