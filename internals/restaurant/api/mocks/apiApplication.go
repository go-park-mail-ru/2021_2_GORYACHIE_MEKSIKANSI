...
// Source: 2021_2_GORYACHIE_MEKSIKANSI/internals/restaurant/application (interfaces: RestaurantApplicationInterface)
...
func (m *MockRestaurantApplicationInterface) AllRestaurants() (*restaurant.AllRestaurantsPromo, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRestaurantApplicationInterfaceMockRecorder) AllRestaurants() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllRestaurants", reflect.TypeOf((*MockRestaurantApplicationInterface)(nil).AllRestaurants))
}

// CreateReview mocks base method.
func (m *MockRestaurantApplicationInterface) CreateReview(arg0 int, arg1 restaurant.NewReview) error {
	m.ctrl.T.Helper()
...
func (m *MockRestaurantApplicationInterface) GetFavoriteRestaurants(arg0 int) ([]restaurant.Restaurants, error) {
	m.ctrl.T.Helper()
...
func (m *MockRestaurantApplicationInterface) GetRestaurant(arg0, arg1 int) (*restaurant.RestaurantId, error) {
	m.ctrl.T.Helper()
...
func (m *MockRestaurantApplicationInterface) GetReview(arg0, arg1 int) (*restaurant.ResReview, error) {
	m.ctrl.T.Helper()
...
func (m *MockRestaurantApplicationInterface) RecommendedRestaurants() (*restaurant.AllRestaurants, error) {
	m.ctrl.T.Helper()
...
func (m *MockRestaurantApplicationInterface) RestaurantDishes(arg0, arg1 int) (*restaurant.Dishes, error) {
	m.ctrl.T.Helper()
...
func (m *MockRestaurantApplicationInterface) SearchRestaurant(arg0 string) ([]restaurant.Restaurants, error) {
	m.ctrl.T.Helper()
