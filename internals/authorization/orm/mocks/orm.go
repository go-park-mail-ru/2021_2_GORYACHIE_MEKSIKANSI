...
// Source: 2021_2_GORYACHIE_MEKSIKANSI/internals/authorization/orm (interfaces: WrapperAuthorizationInterface,ConnectAuthServiceInterface)
...
// NewCSRFWebsocket mocks base method.
func (m *MockConnectAuthServiceInterface) NewCSRFWebsocket(arg0 context.Context, arg1 *proto.IdClient, arg2 ...grpc.CallOption) (*proto.WebsocketResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "NewCSRFWebsocket", varargs...)
	ret0, _ := ret[0].(*proto.WebsocketResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// NewCSRFWebsocket indicates an expected call of NewCSRFWebsocket.
func (mr *MockConnectAuthServiceInterfaceMockRecorder) NewCSRFWebsocket(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewCSRFWebsocket", reflect.TypeOf((*MockConnectAuthServiceInterface)(nil).NewCSRFWebsocket), varargs...)
}
