...
const (
	...
	ANewCSRFWebsocketTransactionNotCreate = "transaction create websocket not create"
	ANewCSRFWebsocketNotCommit            = "transaction create websocket not commit"
	ANewCSRFWebsocketNotUpdate            = "update websocket not update"
)
