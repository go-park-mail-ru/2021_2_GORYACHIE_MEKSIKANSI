//go:generate mockgen -destination=mocks/service.go -package=mocks 2021_2_GORYACHIE_MEKSIKANSI/internals/microservice/authorization/application AuthorizationInterface
package service
