//go:generate mockgen -destination=mocks/application.go -package=mocks 2021_2_GORYACHIE_MEKSIKANSI/internals/microservice/authorization/orm WrapperAuthorizationInterface
package Application
...
func (ap *AuthorizationApplication) AuthVK(email string, name string) (*authPkg.Defense, error) {
	return ap.DB.AuthVK(email, name)
}
