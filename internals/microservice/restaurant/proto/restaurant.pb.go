...
type CreateRadiosArray struct {
	...
	Radios []*CreateRadios `protobuf:"bytes,1,rep,name=radios,proto3" json:"radios,omitempty"`
...
type CreateIngredientsArray struct {
	...
	Ingredients []*CreateIngredients `protobuf:"bytes,1,rep,name=ingredients,proto3" json:"ingredients,omitempty"`
	DishId      int64                `protobuf:"varint,2,opt,name=dishId,proto3" json:"dishId,omitempty"`
}
...
var file_restaurant_proto_rawDesc = []byte{
	...
	0x12, 0x30, 0x0a, 0x06, 0x72, 0x61, 0x64, 0x69, 0x6f, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	...
	0x72, 0x65, 0x64, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d,
