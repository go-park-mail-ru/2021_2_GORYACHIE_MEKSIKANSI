...
const (
	...
	RGetRecommendedRestaurantsTransactionNotCreate = "transaction recommended restaurants not create"
	RGetRecommendedRestaurantsNotCommit            = "transaction recommended restaurants not commit"
	RGetRecommendedRestaurantsRestaurantsNotFound  = "recommended restaurants not found"
	RGetRecommendedRestaurantsRestaurantsNotScan   = "recommended restaurants scan error"
	RGetRecommendedRestaurantsRestaurantsNotSelect = "recommended restaurants not select"
	...
	RGetPromoCodesTransactionNotCreate             = "transaction get promo codes not create"
	RGetPromoCodesNotCommit                        = "transaction get promo codes not commit"
	RGetPromoCodesCodesNotSelect                   = "promo codes not select"
)
